	...
	<div class="appointment-section">
		...
		<div class="appointment-box">
			...
			<form action="addAppointment" method="post">
				...
				<label>Gender</label> <select name="gender" class="form-control"
				...
				</select> <label>Age</label> <input type="number" name="age"
					class="form-control" required> <label>Appointment
					Date</label> <input type="date" name="appointmentDate" class="form-control"
					...
					name="phone" class="form-control" required> <label>Diseases</label>
				<input type="text" name="diseases" class="form-control" required>


				<label>Doctor</label> <select name="doctorNameSelect"
